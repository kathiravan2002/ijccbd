  ...
  const featuredTopics = [
    {
      ...
      content: [
        "Authors submitting to the International Journal of Cloud Computing and Big Data (IJCCBD) retain the copyright of their work while granting the journal the right to publish, distribute, and archive it in various formats. ",
    ...
    },
    {
      ...
      content: [
        "Authors submitting to the International Journal of Cloud Computing and Big Data (IJCCBD) warrant that their work is original, free from plagiarism, and does not infringe any third-party rights. ",
    ...
    },
    {
      ...
      content: [
        "The International Journal of Cloud Computing and Big Data (IJCCBD) is committed to maintaining the highest legal and ethical standards in academic publishing.",
