        ...
        <div className='flex '>
            ...
            <div className="text-justify 2xl:mt-[145px] xl:mt-[125px] lg:mt-[125px] mt-[80px]">
                ...
                <div className="bg-white p-3 border rounded-lg shadow-md">
                    ...
                    <div className='flex items-start gap-4 2xl:px-14 xl:px-14 lg:px-18 md:px-18 px-0 '><img src={check} alt="ll" className='w-[26px] h-[20px]' /><p className="text-base mb-2 poppins-regular">The International Journal of Cloud Computing and Big Data ensures a balanced approach to rights management, allowing authors to retain ownership of their intellectual property while granting the journal the right to publish, distribute, and archive their work. </p><br /> </div>
