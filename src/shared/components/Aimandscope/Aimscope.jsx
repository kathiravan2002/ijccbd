            ...
            <div className="text-justify 2xl:mt-[145px] xl:mt-[125px] lg:mt-[125px] mt-[80px]">
                ...
                <div className="w-full grid grid-cols-1 2xl:grid-cols-2  lg:grid-cols-2 mb-6 gap-6 ">
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data aims to advance research and innovation in cloud computing and big data by providing a high-quality platform for knowledge dissemination. </p></div>
                    ...
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data covers a broad range of topics related to cloud computing and big data technologies.</p></div>
                ...
                <div className="bg-white  border rounded-lg shadow-md py-2">
                    ...
                    <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3  gap-2 '><img src={check} alt="ll" className='w-[26px] h-[20px]' /><p className="text-base mb-2 poppins-regular">The International Journal of Cloud Computing and Big Data covers a wide range of research areas, including but not limited to cloud computing architectures, virtualization, and security. </p><br /> </div>
