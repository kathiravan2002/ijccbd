            ...
            <div className="text-justify  2xl:mt-[145px] xl:mt-[125px] lg:mt-[125px] mt-[80px]">
                ...
                <div className="w-full grid grid-cols-1 2xl:grid-cols-2  lg:grid-cols-2 mb-6 gap-6 ">
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data ensures that the final published version of an article, known as the Version of Record (VoR), is the authoritative and citable version. </p></div>
                    ...
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data follows a structured correction policy to maintain the accuracy and credibility of published research. </p></div>
                ...
                <div className="bg-white p-3 border rounded-lg shadow-md">
                    ...
                    <div className='flex items-start gap-4 2xl:px-14 xl:px-14 lg:px-18 md:px-18 px-0 '><img src={check} alt="ll" className='w-[26px] h-[20px]' /><p className="text-base mb-2 poppins-regular">The International Journal of Cloud Computing and Big Data follows a structured correction process to ensure the accuracy and integrity of published research.  </p><br /> </div>
