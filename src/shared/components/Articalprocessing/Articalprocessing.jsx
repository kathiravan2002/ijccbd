            ...
            <div className="text-justify   2xl:mt-[145px] xl:mt-[125px] lg:mt-[125px] mt-[80px]">
                ...
                <div className="w-full grid grid-cols-1 2xl:grid-cols-2  lg:grid-cols-2 mb-6 gap-6 ">
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data (IJCCBD) follows a systematic publication process to ensure the timely and high-quality dissemination of research. </p></div>
                    ...
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data (IJCCBD) offers numerous benefits to authors, including global visibility, rigorous peer review, and fast-track publication. </p></div>
