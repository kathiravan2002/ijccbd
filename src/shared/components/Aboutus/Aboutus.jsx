            ...
            <div className="text-justify  2xl:mt-[145px] xl:mt-[125px] lg:mt-[125px] mt-[80px]">
                ...
                <div className="w-full grid grid-cols-1 2xl:grid-cols-2  lg:grid-cols-2 mb-6 gap-6 ">
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data focuses on cutting-edge research and advancements in cloud computing, big data analytics, and their real-world applications.</p></div>
                    ...
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data is committed to advancing research and innovation in cloud computing and big data technologies. </p></div>
                    ...
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data upholds the highest standards of publication ethics to ensure integrity, transparency, and credibility in scholarly research.  </p></div>
                    ...
                    <div className='border rounded-lg bg-white pb-4 shadow-md'>
                        ...
                        <div className='flex items-start  2xl:px-20 xl:px-20 lg:px-18 md:px-18 px-3 mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>The International Journal of Cloud Computing and Big Data caters to a diverse audience, including researchers, academicians, industry professionals, and policymakers engaged in cloud computing and big data technologies.</p></div>
