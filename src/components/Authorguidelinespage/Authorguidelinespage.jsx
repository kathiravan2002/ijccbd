...
const [activeTab, setActiveTab] = useState(0);
  ...
  return (
    <div>
      <Helmetcomponent title={'Author Guidelines - International Journal of Cloud Computing and Big Data'} />
      <Authorguidelines activeTab={activeTab} setActiveTab={setActiveTab} featuredTopics={featuredTopics}/>
    </div>
  )
}
